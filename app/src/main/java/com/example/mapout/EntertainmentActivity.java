    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i =new Intent(EntertainmentActivity.this, MapsActivity.class);
                startActivity(i);
            ...
            public void run() {
                try {
                    ...
                    runOnUiThread(() -> {
                        ...
                        //titles.add(result);
                        ArrayAdapter arrayAdapter = new ArrayAdapter(EntertainmentActivity.this, android.R.layout.simple_list_item_1, titles);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(EntertainmentActivity.this, VenueDetailActivity.class);
